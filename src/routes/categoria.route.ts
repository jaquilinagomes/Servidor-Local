...
router.put(CategoriaRoute.update, authorize([Role.ADMIN]), isOwner(EmpresaModel, "owner"), CategoriaController.update)

router.delete(CategoriaRoute.delete, authorize([Role.ADMIN]), isOwner(EmpresaModel, "owner"), CategoriaController.delete)
